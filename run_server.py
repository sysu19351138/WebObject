...
if __name__ == '__main__':
    ...
    mysql_sql.SERVICE_INFO_insert("Service2", "trainable model ", "Service2 with trained model", False, True, "wuchh25")
    mysql_sql.SERVICE_INFO_insert("Service3", "trainable model ", "Service3 with trained model", False, False, "wuchh25")
